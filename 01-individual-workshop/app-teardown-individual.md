...
- Với case rủi ro như bị lừa mất tiền trên ví MoMo, bot phải nhận diện đây là tình huống khẩn cấp và hướng dẫn user báo cáo/khoá ví/liên hệ hỗ trợ.
...
| Failure | Khi AI sai, user biết bằng cách nào và sửa thế nào? | Khi user báo bị lừa mất 1.5 triệu trên ví MoMo, Moni xử lý như câu ngoài phạm vi. Đây là failure nguy hiểm vì user đang cần hướng dẫn báo cáo/khoá ví/liên hệ hỗ trợ. |
